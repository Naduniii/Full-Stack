...
Simple Social is a full-stack application built using FastAPI, Streamlit, SQLite, and ImageKit. The project demonstrates authentication with JWT, media uploads to the cloud, database integration, and a frontend interface for sharing and viewing image and video posts.
